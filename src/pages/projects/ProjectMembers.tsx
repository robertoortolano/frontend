...
import { UserPlus, Trash2, Search, ArrowLeft } from "lucide-react";
...
export default function ProjectMembers() {
  ...
  if (loading) {
    return <div className={layout.loading}>Caricamento membri...</div>;
  }
  ...
  return (
    <div className={layout.container}>
      <div className="flex items-center gap-4 mb-4">
        ...
        <h1 className={layout.title} style={{ margin: 0 }}>Membri del Progetto</h1>
      </div>
      <p className={layout.paragraphMuted}>
        Gestisci chi può accedere a questo progetto e con quale ruolo.
      </p>
