...
const fieldSetImpactConfig: EnhancedImpactReportConfig<FieldSetRemovalImpactDto> = {
...
export const FieldSetEnhancedImpactReportModal: React.FC<FieldSetEnhancedImpactReportModalProps> = (props) => (
