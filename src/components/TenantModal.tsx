...
const TenantModal = ({ show, onClose, formData, handleChange, handleSubmit, isLoading }: TenantModalProps) => {
  if (!show) return null;
      ...
      <div style={modalStyle.modal} onClick={(e) => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={modalStyle.buttonGroup}>
            <button type="button" onClick={onClose} style={modalStyle.cancelButton as CSSProperties} disabled={isLoading}>
              Annulla
            </button>
            <button
              type="submit"
