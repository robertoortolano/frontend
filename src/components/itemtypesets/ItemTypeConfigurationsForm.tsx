...
export function ItemTypeConfigurationsForm({
  ...
  return (
    <div className={form.formGroup} style={{ 
      width: "100%", 
      maxWidth: "100%", 
      ...
      <label className={form.label} style={{ marginBottom: "0.5rem", display: "block" }}>ItemTypeConfigurations</label>
      ...
      <div style={{ 
        ...
        <div className={form.inlineGroup} style={{
          flexWrap: "wrap",
          width: "100%",
          maxWidth: "100%",
          boxSizing: "border-box",
